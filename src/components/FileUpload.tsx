      ...
      <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
        <div className="flex gap-3">
          ...
          <div className="text-sm text-amber-800">
            <p className="font-semibold mb-1">How to get your CSV files:</p>
            <ul className="list-disc list-inside space-y-1 text-amber-700">
              <li>
                <strong>Crypto.com:</strong> App → Accounts → Transaction History → Export
              </li>
              <li>
                <strong>Coinbase:</strong> Settings → Taxes → Generate Report → Download CSV
              </li>
            </ul>
          </div>
        </div>
